...
# -*- coding: utf-8 -*-
"""
Execucao do skill_filtro.md - Filtro de Notas a Imprensa do MRE
Tema (contexto01.md): Governanca Global Digital e tudo que a envolve
(internet, IA, dados e demais tecnologias digitais).

Abordagem: o agente atua como profissional humano lendo as notas.
...
referenciando o conteudo efetivo de cada nota.
"""
...
def avaliar(nota):
    ...
    # Criterio qualitativo: a nota deve ter conexao direta e substancial.
